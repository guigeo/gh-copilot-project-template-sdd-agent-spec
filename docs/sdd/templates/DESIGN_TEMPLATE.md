...
## Specialist Context Assignment

> No Copilot, não há subagentes autônomos. Mapeie cada grupo de arquivos ao contexto
> que o Build deve carregar: chat mode (`.github/chatmodes/`), instruction file
> (`.github/instructions/`, aplicado por `applyTo`) e/ou KB (`.github/context/`).
...
- KBs disponíveis: `.github/context/**`
- Chat modes: `.github/chatmodes/**`  |  Instruções por arquivo: `.github/instructions/**`
- Casar por: tipo de arquivo, palavras-chave de propósito, domínio de KB
...
**Ready for:** `#file:.github/prompts/04-build.prompt.md` + `#file:docs/sdd/features/DESIGN_{FEATURE_NAME}.md`

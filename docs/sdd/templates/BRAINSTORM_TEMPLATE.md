...
| Relevant KB Domains | {pyspark, delta-lake, etc.} | {Patterns to consult} |
...
**Ready for:** `#file:.github/prompts/02-define.prompt.md` + `#file:docs/sdd/features/BRAINSTORM_{FEATURE_NAME}.md`

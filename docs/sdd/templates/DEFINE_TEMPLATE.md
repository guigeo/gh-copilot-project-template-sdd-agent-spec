...
| **KB Domains** | {pyspark, delta-lake, qualidade-de-dados, etc.} | {Which patterns to consult} |
...
- **KB Domains** → Design phase pulls correct patterns from `.github/context/`
...
**Ready for:** `#file:.github/prompts/03-design.prompt.md` + `#file:docs/sdd/features/DEFINE_{FEATURE_NAME}.md`

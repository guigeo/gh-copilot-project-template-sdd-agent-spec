...
```bash
# Copy template
cp docs/dev/templates/PROMPT_TEMPLATE.md \
   docs/dev/tasks/PROMPT_MY_TASK.md
...
| File | Purpose |
|------|---------|
| `.github/prompts/dev.prompt.md` | Definição do comando (crafting + execução) |
| `docs/dev/templates/PROMPT_TEMPLATE.md` | Blank PROMPT template |
| `docs/dev/templates/PROMPT_EXAMPLE_FEATURE.md` | Example: Python utility |
| `docs/dev/templates/PROMPT_EXAMPLE_KB.md` | Example: KB domain |
| `docs/dev/templates/PROGRESS_TEMPLATE.md` | Progress file template |
| `docs/dev/examples/` | Real-world examples from actual feature builds |
